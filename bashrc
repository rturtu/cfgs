...
function comp(){
	...
	if [[ $filetype == cpp ]]; then
		time g++ -Wall -DMY_PC -g -lm -std=c++17 $1 -o .$name;
...
__conda_setup="$('/home/razvan/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/razvan/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/razvan/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/razvan/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
